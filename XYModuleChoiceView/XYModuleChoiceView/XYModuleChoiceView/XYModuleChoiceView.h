...
- (void)moduleChoice:(XYModuleChoiceView * _Nonnull)mchoiceView didSelectRow:(NSUInteger)index; //index从0开始
...
@required
- (NSUInteger)numberOfModules;//有多少个分块
- (nonnull UIView *)sliderView;//滑块
- (nonnull UIButton *)moduleChoice:(XYModuleChoiceView * _Nonnull)moduleChoiceView headerViewAtIndex:(NSUInteger)index;//标题
- (nonnull UIViewController *)moduleChoice:(XYModuleChoiceView * _Nonnull)moduleChoiceView bottomViewAtIndex:(NSUInteger)index;//内容
